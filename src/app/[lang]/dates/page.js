...
export default async function DatesPage({ params }) {
  ...
  return (
    <div className="bg-bg text-white">
      ...
      <section className="relative overflow-hidden pt-32 pb-44 md:pt-40 md:pb-56 text-white text-center bg-cover bg-center" style={{ backgroundImage: "url('/assets/hero_dates.png')" }}>
